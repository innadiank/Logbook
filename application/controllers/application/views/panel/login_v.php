...
<html lang="id" >
  <head>
    ...
    <style>
      ...
      body {
        color: #999999;
        background-image: url("<?php echo base_url('assets/panel/new.jpg')?>");
...
<form method="post" autocomplete="off">
  <p class="intro1"></p>
  <br><br><br><br><br>
	<p class="intro2"; style=color:red;background-color:white;margin-left:500px;margin-right:500px;margin-top:30px;font-family:Apple Chancery><b>The USERNAME or PASSWORD you entered is INCORRECT !!!</b></p>
...
<span class='morphButton'>
	<img class="avatar"   src="<?php echo base_url('dist/img/logoSipuja.png')?>">
